async function exportarPDFYExcel() {
  ...
  // Título en el PDF
  doc.setFontSize(14);
  doc.text("INFORME DE INVENTARIO " + document.getElementById("movil").value, 10, y);
  y += 10;
  ...
  y += 6;
  doc.text("Tecnico Medidor: " + document.getElementById("medidor").value, 10, y);
  y += 6;
  ...
  XLSX.utils.book_append_sheet(wb, ws, "Inventario FO");

  // Guardar el archivo Excel
  XLSX.writeFile(wb, "inventario_FO_" + document.getElementById("movil").value + "_" + document.getElementById("placa").value + ".xlsx");
}
